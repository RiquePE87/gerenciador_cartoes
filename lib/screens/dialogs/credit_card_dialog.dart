          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  onChanged: (txt) => value.cc.bestDay = int.tryParse(txt),
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                      isDense: true,
                ...
                TextFormField(
                  onChanged: (txt) => value.cc.limitCredit = double.tryParse(txt.replaceAll(RegExp("[^0-9]"), "")) / 100,
                  keyboardType: TextInputType.number,
                  inputFormatters: [
                ...
                TextFormField(
                  onChanged: (txt) => value.cc.usedLimit = double.tryParse(txt.replaceAll(RegExp("[^0-9]"), "")) / 100,
                  keyboardType: TextInputType.number,
                  inputFormatters: [
                    FilteringTextInputFormatter.digitsOnly,
